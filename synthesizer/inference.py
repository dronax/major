...
from synthesizer.model.tacotron import Tacotron
from synthesizer.symbols import symbols
from synthesizer.text import text_to_sequence
...
class Synthesizer:
    ...
    def synthesize_spectrograms(self, texts: List[str],
        ...
        inputs = [text_to_sequence(
            text.strip(), hparams.tts_cleaner_names) for text in texts]
